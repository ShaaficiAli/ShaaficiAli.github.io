...
module.exports = function(app){
    ...
    app.get('/analysis', function(req, res){
        ...
        var discovery = readData("discovery");
        var style = readData("style");
        var UIDesignImportance = readData("UIDesignImportance");
        var maxuielem = readData("maxuielem");
        var website = readData("website");
        res.render('showResults', {results: [color,website, style, UIDesignImportance, maxuielem, discovery]});
        console.log([color,website, style, UIDesignImportance, maxuielem, discovery]);
    });
